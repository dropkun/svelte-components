<script lang="ts">
	import type { Circle3Types } from './type.js';
	import '$lib/global.css';
	import { primary, primary_dark, primary_lighter1 } from '../color.js';
	export let size: Circle3Types['size'] = '60';
	export let unit: Circle3Types['unit'] = 'px';
	export let pause: Circle3Types['pause'] = false;
	export let ballTopLeft: Circle3Types['ballTopLeft'] = primary;
	export let ballTopRight: Circle3Types['ballTopRight'] = primary_dark;
	export let ballBottomLeft: Circle3Types['ballBottomLeft'] = primary_lighter1;
